...
function f8() {
   let inp = +document.querySelector('.s-8').value;
...
function f10() {
   let inp = +document.querySelector('.s-100').value;
...
function f11() {
   let inp = +document.querySelector('.s-110').value;
...
function f14() {
   ...
   let inp1 = +document.querySelector('.i-142').value;
   let sel = document.querySelector('.s-143').value;
   let out = document.querySelector('.out-14');

   if (sel === "+") {
      out.innerHTML = inp + inp1;
   } else if (sel === "-") {
      out.innerHTML = inp - inp1;
   } else if (sel === "*") {
      out.innerHTML = inp * inp1;
...
function f15() {
   ...
   let sel1 = document.querySelector('.s-152').value;
   let sel2 = document.querySelector('.s-153').value;
   let out = document.querySelector('.out-15');

   if (sel2 === '&&') {
      out.innerHTML = sel && sel1
   } else {
      out.innerHTML = sel || sel1
   }
}
